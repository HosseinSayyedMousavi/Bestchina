...
class CategoryAdmin(ImportExportModelAdmin):
    ...
    readonly_fields= ("Code","Name","FarsiName","ParentCode","Status","errors","ItemList","number_of_items")
...
class ImporterAdmin(admin.ModelAdmin):
    ...
    exclude = ["start_job"]
    readonly_fields = ("is_periodic","period_length","category","category_prepared_Items","Progress_percentage","period_number","Number_of_products","Number_of_checked_products","errors","updated_at","created_at","current_Item","operation","formula")
