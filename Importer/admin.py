...
class ImporterAdmin(admin.ModelAdmin):
    ...
    exclude = ["start_job"]
    readonly_fields = ("is_periodic","period_length","category","category__number_of_items","Progress_percentage","Progress_bar","period_number","Number_of_products","Number_of_checked_products","errors","updated_at","created_at","current_Item","operation","formula")
